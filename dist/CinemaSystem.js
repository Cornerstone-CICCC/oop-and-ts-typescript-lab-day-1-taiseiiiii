...
function bookSeat(movieId, rowLetter, seatNumber) {
    ...
    var seatIndex = movie.availableSeats.findIndex(function (s) { return s[0] === rowLetter && s[1] === seatNumber; });
    if (seatIndex === -1)
...
function checkSeatAvailability(movieId, rowLetter, seatNumber) {
    var movie = movies.find(function (m) { return m.movieId === movieId; });
    return movie.availableSeats.some(function (s) { return s[0] === rowLetter && s[1] === seatNumber; });
}
